    ...
    <div className="h-full flex flex-col">
      ...
      <div className="flex-shrink-0 px-6 py-4 bg-gray-50 border-t border-gray-200">
        ...
        <button
          ...
          className="w-full sm:w-auto px-4 py-3 text-base sm:text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 active:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed touch-manipulation"
        ...
        <button
          onClick={onSubmit}
          disabled={isSubmitting}
          className="w-full sm:w-auto px-6 py-3 text-base sm:text-sm font-medium text-white bg-blue-600 border border-transparent rounded-md hover:bg-blue-700 active:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center touch-manipulation"
          style={{ minHeight: '44px' }}
        >
          {isSubmitting ? (
            <>
