...
const ContactPage: React.FC = () => {
  const [formData, setFormData] = useState({
    ...
    subject: '',
    message: '',
    type: 'general' as 'general' | 'support' | 'business' | 'press'
  });
  ...
  const contactInfo = [
    {
      ...
      title: 'Email Us',
      details: ['hello@jobboard.com', 'support@jobboard.com'],
    ...
    },
    {
      ...
      description: 'Monday to Friday from 8am to 6pm PST.'
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: 'Visit Us',
      details: ['123 Tech Street, Suite 100', 'San Francisco, CA 94105'],
      description: 'Come visit our office in the heart of SOMA.'
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const faqs = [
    {
      ...
      answer: 'Create an employer account, choose your plan, and follow our simple job posting wizard. Jobs are typically live within 15 minutes.'
    },
    {
      question: 'Is there a fee for job seekers?',
      answer: 'No, our platform is completely free for job seekers. You can search, apply, and manage applications at no cost.'
    },
    {
      question: 'How do I edit or delete my job posting?',
      answer: 'Log into your employer dashboard where you can edit, pause, or delete your job postings at any time.'
    },
    {
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-900 font-medium">9:00 AM - 2:00 PM PST</span>
                  </div>
                  <div className="flex justify-between">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Visit our office in the heart of San Francisco</p>
          </div>
