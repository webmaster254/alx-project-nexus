...
MIDDLEWARE = [
    ...
    'apps.common.audit.AuditLoggingMiddleware',
    'apps.common.throttling.RateLimitMiddleware',
...
# For Docker development, use local database without SSL
if os.environ.get('DOCKER_ENV') == 'development':
    DATABASES = {
        'default': {
